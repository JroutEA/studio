...
const prompt = ai.definePrompt({
  ...
  The user will provide a query describing the desired characteristics of a character. You should analyze this query and identify at least 3 characters from SWGOH that best match these characteristics.
